    ...
    return (
        ...
        <p class = "section__subtitle section__subtitle--projects">Hover over the images to see the project type</p>
            ...
            <div class="project__container">
                <img src = "img/home/art_gallery.jpg" alt="art-project cover" width="900" class = "portfolio__img project__img"></img>
                <div class="project__box">
                <p class="project__text drawPro_"></p>
                </div>
            </div>
            </a>
            ...
            <div class="project__container">
                <img src = "img/home/photography_cover.jpg" alt="photo-project cover" width="900" class = "portfolio__img project__img"></img>
                <div class="project__box">
                <p class="project__text photoPro_"></p>
                </div>
            </div>
            </a>
