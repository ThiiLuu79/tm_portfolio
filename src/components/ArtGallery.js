    ...
    return (
        <div>
            ...
            <section className="intro">
                <h2 className = "section__title section__title--intro">Welcome to my <strong className="name"><b className="drawPro_name">Art Gallery</b></strong> </h2>
                <p className = "section__subtitle section__subtitle--intro drawPro_type">Art Project</p>
            ...
            <div className="art_gallery_link">Art works are also displayed on my <a href="https://www.instagram.com/thiiluu.art/" target="_blank" rel="noreferrer">Art Instagram Page</a>.</div>
