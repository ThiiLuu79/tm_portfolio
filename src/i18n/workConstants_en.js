...
export const INTACT_EXPERIENCE = {
    ...
    tools: ["Environment: MacOS, Windows", "Languages: Angular, TypeScript, HTML, CSS/SASS", "Methodology: Agile, Scrum, SAFe", "Others: NgRx, RxJS, NodeJS, Jest, Git/Github, IntelliJ, VSCode, SonarQube, Jira, Confluence, Teams"],
    imgAlt: "intact",
