...
export const COOKINGLAB_PROJECT = {
    ...
    tools: [
        ...
        "Architecture: Micro-frontends, Redux, MCV Pattern",
        "Methodologie: Kanban",
        "Outil(s): Git/GitHub, GitHub Project Board, VSCode, IntelliJ, AxureRP, Edamam API, Postman, Swagger, Netlify, Render, Microsoft Teams"
    ],
    imgAlt: "cookinglab"
};
